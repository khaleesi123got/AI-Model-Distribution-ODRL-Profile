...
> Dissertation Project — Trinity College Dublin, 2026  
...
- Extending an existing ODRL profile ([original work by Cian Twomey, 2024](https://github.com/ci2me/AI-Model-Distribution-ODRL-Profile)) with new obligations
...
```
├── AIMD.ttl                        # Core ODRL profile (Cian Twomey, 2024)
├── AIMD_extended.ttl               # extensions — CO₂, copyright, provenance
...
**`AIMD.ttl`** — The original AI Model Distribution ODRL Profile by Cian Twomey. Defines core vocabulary terms for AI Act prohibited uses (social scoring, biometric identification, emotional inference, etc.) and foundational obligations.

**`AIMD_extended.ttl`** — extensions added in this dissertation. Introduces:
...
**`server.js`** — Node.js server implementing:
...
- **Original AIMD Profile:** [Cian Twomey (2024)](https://github.com/ci2me/AI-Model-Distribution-ODRL-Profile)
